...
**Important:** Vercel uses serverless functions. For production:
- Use external database (e.g., Neon, PlanetScale) by setting `DATABASE_URL` environment variable
- Or accept that in-memory database will reset on each deployment
